...
/// @nodoc
@JsonSerializable()
class _$_ParallelLeningen implements _ParallelLeningen {
...
/// @nodoc
@JsonSerializable()
class _$_StatusLening implements _StatusLening {
  ...
  @override
  String toString() {
    return 'StatusLening(id: $id, lening: $lening, periode: $periode, rente: $rente, toetsRente: $toetsRente, periodesTotVolgendeRente: $periodesTotVolgendeRente, aflosTermijnInMaanden: $aflosTermijnInMaanden, hypotheekVorm: $hypotheekVorm, verduurzaamKosten: $verduurzaamKosten, verbouwKosten: $verbouwKosten)';
  }
