...
class __$$LenningAanpassenInTermijnenCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$LenningAanpassenInTermijnen(
      ...
      aantal: null == aantal
          ? _value.aantal
          : aantal // ignore: cast_nullable_to_non_nullable
              as int,
      intervalInMaanden: null == intervalInMaanden
          ? _value.intervalInMaanden
          : intervalInMaanden // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
class _$LenningAanpassenInTermijnen extends LenningAanpassenInTermijnen {
  const _$LenningAanpassenInTermijnen(
      ...
      required this.intervalInMaanden,
      final String? $type})
      : $type = $type ?? 'termijnen',
        super._();
  ...
  @override
  String toString() {
    return 'LeningAanpassen.termijnen(datum: $datum, leningAanpassenOpties: $leningAanpassenOpties, bedrag: $bedrag, aantal: $aantal, intervalInMaanden: $intervalInMaanden)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.aantal, aantal) || other.aantal == aantal) &&
            (identical(other.intervalInMaanden, intervalInMaanden) ||
                other.intervalInMaanden == intervalInMaanden));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, datum, leningAanpassenOpties,
      bedrag, aantal, intervalInMaanden);
...
abstract class LenningAanpassenInTermijnen extends LeningAanpassen {
  const factory LenningAanpassenInTermijnen(
      ...
      required final int aantal,
      required final int intervalInMaanden}) = _$LenningAanpassenInTermijnen;
