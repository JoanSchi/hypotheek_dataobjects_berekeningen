...
class HypotheekDossierOverzicht with _$HypotheekDossierOverzicht {
  ...
  const factory HypotheekDossierOverzicht({
    @Default(IMapConst({})) IMap<String, HypotheekDossier> hypotheekDossiers,
    @Default('') String geselecteerd,
  ...
  HypotheekDossier? get hypotheekDossierGeselecteerd =>
      hypotheekDossiers[geselecteerd];
}
