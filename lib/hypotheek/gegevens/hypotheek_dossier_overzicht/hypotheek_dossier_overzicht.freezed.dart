...
mixin _$HypotheekDossierOverzicht {
  IMap<String, HypotheekDossier> get hypotheekDossiers =>
      throw _privateConstructorUsedError;
  String get geselecteerd => throw _privateConstructorUsedError;
...
abstract class $HypotheekDossierOverzichtCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {IMap<String, HypotheekDossier> hypotheekDossiers, String geselecteerd});
}
    ...
    return _then(_value.copyWith(
      hypotheekDossiers: null == hypotheekDossiers
          ...
          : hypotheekDossiers // ignore: cast_nullable_to_non_nullable
              as IMap<String, HypotheekDossier>,
...
class _$_HypotheekDossierOverzicht extends _HypotheekDossierOverzicht {
  const _$_HypotheekDossierOverzicht(
      {this.hypotheekDossiers = const IMapConst({}), this.geselecteerd = ''})
      : super._();
  ...
  @override
  @JsonKey()
  final IMap<String, HypotheekDossier> hypotheekDossiers;
  @override
  @JsonKey()
...
abstract class _HypotheekDossierOverzicht extends HypotheekDossierOverzicht {
  const factory _HypotheekDossierOverzicht(
      {final IMap<String, HypotheekDossier> hypotheekDossiers,
      final String geselecteerd}) = _$_HypotheekDossierOverzicht;
